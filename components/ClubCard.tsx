  ...
  return (
    ...
    >
      <div className="aspect-[4/3] w-full bg-[rgb(var(--surface-3))]">
        <img loading="lazy" src={club.images.jpg.image_url} alt={club.name} className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105" />
      </div>
      <div className="p-4">
